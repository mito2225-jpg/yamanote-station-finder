...
export function validateFormInput(value: string, fieldName: string, required = true): string {
...
export function validateAnswerSelection(questionId: string, selectedOptionId: string): void {
  if (!questionId || typeof questionId !== 'string') {
    throw new ValidationError('Question ID is required for answer selection');
  }
  
  if (!selectedOptionId || typeof selectedOptionId !== 'string') {
    throw new ValidationError('Selected option ID is required for answer selection');
  }
}
